...
GNUは2020年代に入り2020/08/10にGNU Emacs-27.1、2022/04/04に28.1、2023/07/30に29.1とメジャーバージョンを順次リリースしています。
...
メジャーなディストリビューションにおいてはOS標準のパッケージマネージャで "emacs" をインストールした際に、まだGNU Emacs 27がインストールされると思います。
